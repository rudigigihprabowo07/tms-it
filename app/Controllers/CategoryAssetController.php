...
class CategoryAssetController extends ResourceController
{
    protected $modelName = 'App\Models\CategoryAssetModel';
    ...
    {
        $data = $this->model->getSpecificCategoryAsset($id);
